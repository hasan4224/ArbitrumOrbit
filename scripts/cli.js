...
const contractABI = require("../artifacts/contracts/Arbitrumorbit.sol/Arbitrumorbit.json").abi;

program
    .name("arbitrumorbit-cli")
    .description("CLI tool for Arbitrumorbit smart contract")
    .version("1.0.0");
